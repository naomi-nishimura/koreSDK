(function(KoreSDK){
    ...
    botOptions.JWTUrl = "http://localhost:3000/generateJWT";
    botOptions.userIdentity = 'nishimura.naomi.qq8@p.jp.nssol.nipponsteel.com';// Provide users email id here
    botOptions.botInfo = { name: "WebSDKテスト", "_id": "st-3e628e4f-2578-5322-bdf6-54eaf3955f9b" }; // bot name is case sensitive
    ...
    **/
    botOptions.clientId = "cs-0b85045f-9a0a-501c-8a25-3f6735404ede";
    botOptions.clientSecret = "KO99ZLqbOX9sZI3KqG1MM3j2NDsTe4zXF5HDGM38W+s=";
